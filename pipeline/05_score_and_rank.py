...
from config import (
    ...
    W_HOME_VALUE, W_AIR_QUALITY,
    CAP_GROCERY, CAP_CAFE, CAP_RESTAURANT, CAP_PHARMACY, CAP_TRANSIT, CAP_PM25,
...
def compute_scores(df: pd.DataFrame, region: str) -> pd.DataFrame:
    ...
    # Scale down base weights to make room for hiking, affordability, and air quality
    fixed_weight = hiking_weight + affordability_weight + air_quality_weight
    if fixed_weight > 0:
